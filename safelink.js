    ...
    _utf8_decode: function(utftext) {
        ...
        while (i < utftext.length) {
            ...
            if (c < 128) { string += String.fromCharCode(c);
                i++; } else if ((c > 191) && (c < 224)) { c2 = utftext.charCodeAt(i + 1);
...
function auto_safeconvert() {
    ...
    for (var i = 0; i < a_to_va; i++) {
        ...
        if (a_to_vh == false) { var encryptedUrl = Base64.encode(a_to_vi);
            a_to_ve[i].href = "https://safe.bojez.com/p/decrypt.html?url=" + encryptedUrl;
...
function a_to_fa() { var a_to_vf = new Array();
